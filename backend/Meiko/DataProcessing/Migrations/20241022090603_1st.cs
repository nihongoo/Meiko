    ...
    public partial class _1st : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "Tên thương hiệu phải từ 3 đến 100 ký tự"),
                    BrandCode = table.Column<int>(type: "int", nullable: false, comment: "Mã thương hiệu lớn hơn 0"),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 1, comment: "Trạng thái thương hiệu từ 0 đến 5")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SaleCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TargretCustomers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Sex = table.Column<bool>(type: "bit", nullable: false, comment: "Giới tính không được để trống."),
                    BirthDay = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Ngày sinh không được để trống."),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Số điện thoại không được để trống."),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Email không được để trống."),
                    Status = table.Column<int>(type: "int", nullable: false, comment: "Trạng thái không được để trống."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargretCustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_TargretCustomers_TargretCustomerId",
                        column: x => x.TargretCustomerId,
                        principalTable: "TargretCustomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Thời gian tạo không được để trống"),
                    Total = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "Tổng tiền phải lớn hơn hoặc bằng 0"),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 1, comment: "Trạng thái phải từ 0 đến 5"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    VoucherId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Id voucher không được để trống."),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Id khách hàng không được để trống."),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 0, comment: "Trạng thái không được để trống.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteProducts_Customers_IdCustomer",
                        column: x => x.IdCustomer,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteProducts_Products_IdProduct",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false, defaultValue: 1, comment: "Số lượng sản phẩm trong chi tiết hóa đơn"),
                    Price = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, comment: "Giá của sản phẩm trong chi tiết hóa đơn"),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 1, comment: "Trạng thái chi tiết hóa đơn: 0-Hủy, 1-Đang xử lý, 2-Hoàn thành"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false, defaultValue: 1, comment: "Số lượng phải lớn hơn hoặc bằng 1"),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "Giá phải lớn hơn hoặc bằng 0"),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 1, comment: "Trạng thái phải từ 0 đến 5"),
